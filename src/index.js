...
var serial_1 = require("@novastar/serial");
...
// serial.release();
var test = serial_1["default"]["default"];
var test2 = await test.findSendingCards();
...
app.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, res.status(200).json(novastarData)];
    });
}); });
try {
    app.listen(PORT, function () { console.log("Server started on port ".concat(PORT)); });
